   ...
   // private static String address="98:D3:32:11:74:7F";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Intent intent = getIntent();
         //String address = intent.getStringExtra("EXTRA_SESSION_ID");

       // Log.e("Dekh lena", "Dekh lena" + sessionId);
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case RECIEVE_MESSAGE:                                                    // if receive massage
                        ...
                        if (strIncom.equals(47)) {
                            Toast.makeText(getApplicationContext(), strIncom, Toast.LENGTH_LONG).show();
                        }
                        Log.e("Logcat Details=>","Logcat Details=>"+strIncom);
                        //Log.e("arg","arg"+msg.arg1);
                        //Log.e("arg","arg"+msg.arg2);
        ...
        submit2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String output = parseFormat.format(currentTime);
                ...
                try {
                    ...
                    if (outTime1.before(inTime1)) {
                        AlertDialog.Builder dialog = new AlertDialog.Builder(Timer.this);
                        dialog.setCancelable(true);
                        dialog.setTitle("Warning...");
                        dialog.setMessage("Invalid Time..." );
                        ...
                        String x=result+"@T1_S"+starttime+",E"+endtime+"T2_S"+starttime1+",E"+endtime1+"$";
                        //String x = starttime + endtime + starttime1 + endtime1;
                        int z=x.length();
                        Log.e("string-Length","String-length"+z);
                        x = x.replace("AM", "");
                        x = x.replace("PM", "");
    ...
    public void onResume() {
        ...
        Log.e("Dekh lena", "Dekh lena" + address);
